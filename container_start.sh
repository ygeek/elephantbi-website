...
sed -i "s/DATATECH_URL/${XYDATATECH_URL}/g" $indexFile
...
sed -i "s/DATATECH_URL/${XYDATATECH_URL}/g" $serverFile
...
sed -i "s/DATATECH_URL/${XYDATATECH_URL}/g" $demoFile
...
sed -i "s/DATATECH_URL/${XYDATATECH_URL}/g" $priceFile
...
sed -i "s/DATATECH_URL/${XYDATATECH_URL}/g" $indexFileEn
...
sed -i "s/DATATECH_URL/${XYDATATECH_URL}/g" $serverFileEn
...
sed -i "s/DATATECH_URL/${XYDATATECH_URL}/g" $demoFileEn
...
sed -i "s/DATATECH_URL/${XYDATATECH_URL}/g" $priceFileEn
registerFile=/usr/share/nginx/html/register.html
sed -i "s/https:\/\/api.elephantbi.com/${BACKEND_URL}/g" $registerFile
sed -i "s/DEMO_URL/${DEMO_URL}/g" $registerFile
registerInfoFile=/usr/share/nginx/html/register-info.html
...
sed -i "s/DATATECH_URL/${XYDATATECH_URL}/g" $indexFileHk
...
sed -i "s/DATATECH_URL/${XYDATATECH_URL}/g" $serverFileHk
...
sed -i "s/DATATECH_URL/${XYDATATECH_URL}/g" $demoFileHk
...
sed -i "s/DATATECH_URL/${XYDATATECH_URL}/g" $priceFileHk
registerFile=/usr/share/nginx/html/register.html
sed -i "s/https:\/\/api.elephantbi.com/${BACKEND_URL}/g" $registerFile
sed -i "s/DEMO_URL/${DEMO_URL}/g" $registerFile
registerInfoFile=/usr/share/nginx/html/register-info.html
